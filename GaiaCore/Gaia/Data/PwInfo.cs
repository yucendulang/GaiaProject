...
namespace GaiaCore.Gaia.Data
{
    ...
    public class PwInfoList
    {
        ...
        {
            new PwInfo(){code = "burn 1.convert 1bs to 1o",name = "牺牲1能量1个智慧石兑换1个矿石"},
            new PwInfo(){code = "burn 1.convert 1bs to 3c",name = "牺牲1能量1个智慧石兑换3点信用点"},
            new PwInfo(){code = "convert 1bs to 1o",name = "1个智慧石兑换1个矿石"},
            new PwInfo(){code = "convert 1bs to 3c",name = "1个智慧石兑换3点信用点"},
            new PwInfo(){code = "convert 1bs,1pw to 1q",name = "1个智慧石和1点能量兑换1个量子方块"},
