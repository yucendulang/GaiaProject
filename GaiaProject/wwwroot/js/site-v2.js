                ...
                //非自己颜色星球
                    ...
                    ///空白星球
                        ...
                        if (clickObj.mapcolor === "#80F080") {
                            ...
                            getMineCost(urlship, "build " + clickObj.position, _("确认进行建造?") + "<br/>" + _("地形转化率:") + cindex, null);
...
var Global = {};
Global.spaceBg = "#000000"; //太空的颜色
Global.haxLine = "#555555"; //小六边形的边线颜色
Global.spaceLine = "#CCCCCC"; //大六边形的颜色
Global.spaceText = "#FFFFFF"; //太空中六边形文字颜色
Global.planetText = "#222222"; //星球上文字的颜色
...
function DrawMap(ctx) {
    ...
    //img.src = "../../images/web-background.jpg";
    //ctx.drawImage(img, 0, 0);
    //console.log("DrawMapBg");
...
function DrawHexSpaceBianjie(ctx, x, y,z,size) {
    ...
    //绘制大六边形边界
    ctx.strokeStyle = Global.spaceLine;
    ctx.lineWidth = 2;
    ctx.stroke();
    ctx.restore();
}
